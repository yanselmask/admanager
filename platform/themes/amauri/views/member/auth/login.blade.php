...
<!-- Login Form -->
 <main class="flex-1 flex items-center justify-center py-5">
    <form method="POST" action="{{route('public.member.login.post')}}" class="bg-slate-900/80 border border-cyan-400/10 shadow-xl rounded-2xl p-8 w-full max-w-md mx-auto space-y-6 backdrop-blur">
        ...
        <div>
            <label class="block text-sm mb-1 font-medium" for="email">Correo electrónico o Nombre de usuario</label>
        ...
        <div class="flex items-center justify-between">
            ...
            <a href="#" class="text-cyan-400 text-sm hover:underline">¿Olvidaste tu contraseña?</a>
        </div>
        <button type="submit" class="w-full py-3 rounded-lg bg-gradient-to-tr from-cyan-500 to-cyan-400 font-semibold shadow hover:-translate-y-1 transition text-lg">Entrar</button>
