@php
    ...
    $bodyAttrs['class'] = 'min-h-screen bg-[#080d18] text-white flex flex-col';
...
<style>
    ...
    .benefit-card:hover { border-color: rgba(6,182,212,0.25); }
</style>
...
<section class="relative pt-28 pb-24 overflow-hidden">
    ...
    <div class="absolute inset-0 pointer-events-none overflow-hidden">
        ...
        <div class="anim-glow absolute -bottom-40 -right-40 w-[500px] h-[500px] rounded-full"
             style="background: radial-gradient(circle, rgba(6,182,212,0.07) 0%, transparent 65%); animation-delay: 2.5s;"></div>
        <div class="absolute inset-0"
             style="background: radial-gradient(ellipse at 50% 110%, rgba(6,182,212,0.05) 0%, transparent 55%);"></div>
    </div>
        ...
        <div class="grid md:grid-cols-2 gap-16 items-center">
            ...
            <div class="anim-slide-up">
                ...
                <div class="flex gap-4 mb-12 flex-wrap">
                    ...
                    <a href="#sistema"
                       class="px-7 py-3.5 rounded-xl font-semibold border text-cyan-400 hover:bg-cyan-400/10 transition-colors duration-200"
                       style="border-color: rgba(6,182,212,0.35);">
                        Ver Demo
                    </a>
                </div>
            ...
            <div class="anim-float relative">
                <div class="absolute -inset-6 rounded-3xl anim-glow"
                     style="background: radial-gradient(ellipse, rgba(6,182,212,0.15), transparent 70%);"></div>
                    ...
                    <div class="p-5">
                        ...
                        <div class="grid grid-cols-2 gap-3 mb-4">
                            <div class="rounded-xl p-4"
                                 style="background:linear-gradient(135deg,rgba(26,85,168,.55),rgba(42,122,228,.35));border:1px solid rgba(42,122,228,.25);">
                            ...
                            <div class="rounded-xl p-4"
                                 style="background:linear-gradient(135deg,rgba(10,110,122,.55),rgba(18,170,191,.35));border:1px solid rgba(18,170,191,.25);">
                        ...
                        {{-- SVG Line chart --}}
                        <div class="rounded-xl p-4 mb-4" style="background:rgba(8,13,24,0.7);border:1px solid rgba(255,255,255,0.05);">
                            <div class="flex justify-between items-center mb-3">
                                ...
                                <span class="text-xs text-cyan-400 px-2 py-0.5 rounded"
                                      style="background:rgba(6,182,212,0.1);">7 días</span>
                            </div>
                            <svg viewBox="0 0 280 72" class="w-full h-14" preserveAspectRatio="none">
                                ...
                                <circle cx="280" cy="8" r="3" fill="#06b6d4"/>
                                <circle cx="280" cy="8" r="6" fill="#06b6d4" opacity="0.22"/>
                            </svg>
                        ...
                        {{-- Referrals list --}}
                        <div class="rounded-xl p-4" style="background:rgba(8,13,24,0.7);border:1px solid rgba(255,255,255,0.05);">
                            <div class="text-xs text-slate-400 mb-3">Referidos activos</div>
                            <div class="flex flex-col gap-2.5">
                                <div class="flex justify-between items-center">
                                    <div class="flex items-center gap-2">
                                        <div class="w-7 h-7 rounded-full flex items-center justify-center text-xs font-bold text-white flex-shrink-0"
                                             style="background:linear-gradient(135deg,#06b6d4,#22d3ee);">J</div>
                                ...
                                <div class="flex justify-between items-center">
                                    <div class="flex items-center gap-2">
                                        <div class="w-7 h-7 rounded-full flex items-center justify-center text-xs font-bold text-white flex-shrink-0"
                                             style="background:linear-gradient(135deg,#06b6d4,#22d3ee);">M</div>
...
{{-- ═══════════════════════════════════════════
     STATS BAR
═══════════════════════════════════════════ --}}
<div style="background:rgba(13,20,35,0.7);border-top:1px solid rgba(255,255,255,0.05);border-bottom:1px solid rgba(255,255,255,0.05);">
                ...
                <div class="flex items-center gap-3 mb-5">
                    ...
                    <div>
                        ...
                        <span class="text-xs text-cyan-400 font-medium px-2.5 py-0.5 rounded-full"
                              style="background:rgba(6,182,212,0.1);">Exclusivo</span>
                    </div>
                </div>
            ...
            <div class="card-feature rounded-2xl p-6">
                <div class="flex items-center gap-3 mb-5">
                    ...
                    <div>
                        ...
                        <span class="text-xs text-cyan-400 font-medium px-2.5 py-0.5 rounded-full"
                              style="background:rgba(6,182,212,0.1);">Tiempo Real</span>
                    </div>
                </div>
            ...
            <div class="card-feature rounded-2xl p-6">
                <div class="flex items-center gap-3 mb-5">
                    ...
                    <div>
                        ...
                        <span class="text-xs text-cyan-400 font-medium px-2.5 py-0.5 rounded-full"
                              style="background:rgba(6,182,212,0.1);">Listo para usar</span>
                    </div>
                </div>
            ...
            <div class="card-feature rounded-2xl p-6">
                <div class="flex items-center gap-3 mb-5">
                    ...
                    <div>
                        ...
                        <span class="text-xs text-cyan-400 font-medium px-2.5 py-0.5 rounded-full"
                              style="background:rgba(6,182,212,0.1);">Ingresos Extra</span>
                    </div>
                </div>
...
{{-- ═══════════════════════════════════════════
     HOW IT WORKS
═══════════════════════════════════════════ --}}
<section class="py-24" style="background:rgba(13,20,35,0.7);">
    <div class="max-w-7xl mx-auto px-4">
        ...
        <div class="grid md:grid-cols-3 gap-8">
            ...
            <div class="text-center group">
                <div class="inline-flex items-center justify-content-center w-20 h-20 rounded-2xl mb-6 text-cyan-400 mx-auto"
                     style="background:linear-gradient(135deg,rgba(6,182,212,0.12),rgba(6,182,212,0.04));border:1px solid rgba(6,182,212,0.22);">
            ...
            <div class="mockup-card rounded-2xl overflow-hidden">
                ...
                <div class="p-5">
                    ...
                    <div class="grid grid-cols-2 gap-3 mb-4">
                        ...
                        <div class="rounded-xl p-4"
                             style="background:linear-gradient(135deg,rgba(96,25,163,.55),rgba(155,89,182,.35));border:1px solid rgba(155,89,182,.25);">
                            <div class="text-slate-400 text-xs mb-1">Impresiones</div>
                            <div class="text-xl font-bold">75,400</div>
                        </div>
                        <div class="rounded-xl p-4"
                             style="background:linear-gradient(135deg,rgba(13,110,63,.55),rgba(39,174,96,.35));border:1px solid rgba(39,174,96,.25);">
                    ...
                    <div class="rounded-xl p-4 mb-4"
                        ...
                        <svg viewBox="0 0 320 80" class="w-full h-20" preserveAspectRatio="none">
                            ...
                            <circle cx="320" cy="8" r="3.5" fill="#06b6d4"/>
                            <circle cx="320" cy="8" r="7"   fill="#06b6d4" opacity="0.2"/>
                        </svg>
                    ...
                    <div class="flex gap-2 flex-wrap">
                        <span class="px-3 py-1.5 rounded-lg text-xs font-medium text-cyan-400"
                              style="background:rgba(6,182,212,0.1);border:1px solid rgba(6,182,212,0.3);">Gestionar Webs</span>
            ...
            <div class="flex flex-col gap-8">
                ...
                <div>
                    ...
                    <div class="rounded-xl overflow-hidden"
                         style="background:rgba(13,20,35,0.9);border:1px solid rgba(255,255,255,0.06);">
...
<section class="py-28 relative overflow-hidden"
         style="background:linear-gradient(135deg,rgba(6,182,212,0.06) 0%,rgba(8,13,24,0.98) 40%,rgba(6,182,212,0.06) 100%);">
    <div class="absolute inset-0 pointer-events-none">
        <div class="anim-glow absolute inset-0 flex items-center justify-center">
            <div class="w-[700px] h-[350px] rounded-full"
                 style="background:radial-gradient(ellipse,rgba(6,182,212,0.09) 0%,transparent 70%);"></div>
        </div>
    </div>
    <div class="max-w-3xl mx-auto px-4 text-center relative z-10">
        ...
        <div class="flex gap-4 justify-center flex-wrap">
            ...
            <a href="{{ route('public.member.login') }}"
               class="px-9 py-4 rounded-xl font-bold text-cyan-400 text-lg border hover:bg-cyan-400/10 transition-colors duration-200"
               style="border-color:rgba(6,182,212,0.35);">
                Iniciar Sesión
            </a>
        </div>
